...
titleTemplate: false
description: 如果你不知道如何用 WorkBuddy 解决真实工作问题，可以提交场景反馈。我们会评估需求、联系沟通，并将具有复用价值的解决方案制作成开源 Case。
...
<div class="help-hero">
  <div class="help-hero__copy">
    ...
    <p class="help-hero__lead">把你的真实问题告诉我们。我们会阅读每一份场景反馈，评估 WorkBuddy 是否能够解决；如果需要补充信息，我们会联系你进一步沟通。</p>
  ...
  <div id="scenario-survey" class="help-survey-card">
    <div class="help-survey-card__heading">
      <span>01</span>
      <div>
        <strong>场景收集调查问卷</strong>
        <small>扫码后填写你的真实需求</small>
      </div>
    </div>
    <div class="help-survey-card__placeholder">
      <span>此处插入二维码图片</span>
    </div>
...
<section class="help-process" aria-labelledby="help-process-title">
  ...
  <div class="help-process__grid">
    ...
    <article>
      <span>03</span>
      <h3>联系与验证</h3>
      <p>如果场景需要更多信息，我们会通过反馈中留下的联系方式与你确认，并验证方案。</p>
    </article>
    <article>
      <span>04</span>
      <h3>制作开源 Case</h3>
...
<div class="help-note">
  ...
  <p>请不要在反馈中提交密码、密钥、客户隐私或不方便公开的内部资料。我们只会在需要补充信息或可以推进解决方案时，通过你主动留下的联系方式与你沟通。</p>
</div>
